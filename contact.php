...
<html class="no-js" lang="fr">
    ...
    <title>Contact | Africa Eagles Group Developper</title>
                  ...
                  <fieldset>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input type="text" placeholder="Nom*" class="form-control" id="form-name" data-error="Ce champ est obligatoire" required>
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" placeholder="Télephone*" class="form-control" id="form-name" data-error="Ce champ est obligatoire" required>
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="email" placeholder="Email*" class="form-control" id="form-email" data-error="Ce champ est obligatoire" required>
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <button type="submit" class="btn-read-more-fill btn-send">Envoyer Message</button>
                      </div>
                    </div>
                    <div class="col-md-8">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="page-sidebar-area">
                <div class="single-sidebar">
                  <h3>Contact Info</h3>
                  <nav class="contact-text">
                    <ul>
                      <li><i class="fa fa-map-marker" aria-hidden="true"></i> Abidjan, plateau dokui</li>
                      <li><i class="fa fa-phone" aria-hidden="true"></i> (+225) 75 13 95 76</li>
                      <li><i class="fa fa-phone" aria-hidden="true"></i> (+225) 75 13 95 76</li>
                      <li><i class="fa fa-envelope-o" aria-hidden="true"></i> sicompcommercial@gmail.com</li>
                    </ul>
                  </nav>
                </div>
              </div>
